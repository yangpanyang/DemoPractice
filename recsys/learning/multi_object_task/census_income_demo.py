...
"""
    @Time : 2020/11/20 7:43 PM
    @Author : Caroline
    @File : 入口函数
    @Description : 调用MMoE模型
"""
...
def data_preparation():
    ...
    validation_indices = transformed_other.sample(frac=0.5, replace=False, random_state=SEED).index  # 固定随机数率，随机抽样
